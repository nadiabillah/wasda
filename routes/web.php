...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/dashboard/fetch', [WhatsAppController::class, 'fetchByOpd']);

    Route::get('/messages', [WhatsAppController::class, 'create'])->name('messages');
...
// Route::get('/generate-usercsv', function () {
//     $users = [
...
//     $csv = "no,username,name,password,email,phone\n";
//     $no = 1;
//     $phoneIndex = 10;
...
//         $phoneRaw = '0812345678' . str_pad($phoneIndex++, 2, '0', STR_PAD_LEFT);
...
//     $path = storage_path('app/private/usercredential.csv');
